        ...
        return (
            ...
            <Navbar color="light" light expand="md">
                ...
                <Nav className="mr-auto" navbar>
                    <NavLink onClick={() => {this.hideComponent("showSignIn")}}>Sign in</NavLink>
                    <NavLink onClick={() => {this.hideComponent("showSignUp"); this.setPodaci("showSignUp");}}>Sign up</NavLink>
                    <NavLink onClick={() => {this.hideComponent("showUpdateAdmin"); this.setPodaci("showUpdateAdmin");}}>Update admin</NavLink>
                    <NavLink onClick={() => {this.hideComponent("showUpdateUser"); this.setPodaci("showUpdateUser");}}>Update user</NavLink>
                </Nav>
            </Navbar>
