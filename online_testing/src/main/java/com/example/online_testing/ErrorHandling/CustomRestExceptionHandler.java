...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleNotFoundException(RecordNotFoundException ex, WebRequest request) {
        ...
        ApiError apiError = new ApiError(HttpStatus.NOT_FOUND, "Record Not Found", error);
        return new ResponseEntity(apiError, apiError.getStatus());
    }
    ...
    public final ResponseEntity<Object> handleAlreadyExistsException(AlreadyExistsException ex, WebRequest request) {
        List<String> error = new ArrayList<>();
        error.add(ex.getLocalizedMessage());
        ApiError apiError = new ApiError(HttpStatus.CONFLICT, "Record Already Exists", error);
        return new ResponseEntity(apiError, apiError.getStatus());
    }
