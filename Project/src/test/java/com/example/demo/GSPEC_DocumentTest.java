...
public class GSPEC_DocumentTest {
    ...
    public void testGetGSPECs() throws Exception{
        ...
        given(gspec_documentRepository.findAll()).willReturn(gspecs);
    ...
    public void testGetGSPECByID() throws Exception {
        ...
        given(gspec_documentRepository.findByID(Long.valueOf(1))).willReturn(gspec);
    ...
    public void updateGSPEC() throws Exception {
        ...
        given(gspec_documentRepository.findByID(Long.valueOf(1))).willReturn(gspec_document);
        gspec_document.setID(Long.valueOf(1));
    ...
    public void testGetGSPECsOfMockup() throws Exception{
        ...
        given(gspec_documentRepository.findAllBymockupID(mockup)).willReturn(gspec_documents);
